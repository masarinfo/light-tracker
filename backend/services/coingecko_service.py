...
def fetch_coingecko_prices():
    """
    Fetches crypto prices directly from Binance Public API and CoinCap API (replacing CoinGecko).
    """
...
def get_cached_prices():
    if not MARKET_DATA_CACHE or (datetime.now() - LAST_FETCH_TIME).total_seconds() > 30:

        ...
        <div className="glass-panel p-6 rounded-2xl border border-white/10 space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-cyan-300">{t('cashAvailable')}: {overviewMetrics.cashPct.toFixed(1)}%</span>
            ...
            <div className="h-2.5 w-full bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden flex" dir="ltr">
              <div style={{ width: `${overviewMetrics.cashPct}%` }} className="bg-cyan-400 h-full"></div>

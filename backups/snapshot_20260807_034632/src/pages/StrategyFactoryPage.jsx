...
import { Factory, Plus, Edit, Trash2, ShieldAlert, Target, Zap, Gem } from 'lucide-react';

export default function StrategyFactoryPage() {
  const { strategies, addStrategy, updateStrategy, exchanges, t } = useApp();
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-indigo-300 hover:text-white text-xs font-bold transition-all"
                  >
